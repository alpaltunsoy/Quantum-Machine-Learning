# -*- coding: utf-8 -*-
"""
Created on Mon Jul 29 14:21:28 2024
...
def quantum_algorithm(x_train, y_train, x_test, y_test):
    ...
    print(f"Quantum VQC on the test dataset: Accuracy={test_accuracy:.2f}, Precision={test_precision:.2f}, Recall={test_recall:.2f}, F1 Score={test_f1:.2f}, Specificity={test_specificity:.2f}")
